...
using amiliur.figforms.shared.Attributes.Datagrid.Models.ColumnTemplates;
using amiliur.shared.Json;

namespace amiliur.figforms.shared.Attributes.Datagrid.Models;
...
public abstract class GridColBase: ISerializableModel
{
    ...
    public virtual TextAlign? TextAlign { get; set; } = null;
